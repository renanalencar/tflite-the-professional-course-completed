...
/**
 * Main activity of the flower classification app devleoped during the Week 1 of the course
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewBreed = findViewById(R.id.textView_flower);
        textViewConfidence = findViewById(R.id.textView_confidence);
    ...
    private void showOutput(String flowerSpecies, float confidence) {
        runOnUiThread(() -> {
            ...
            textViewConfidence.setText(String.format("%.2f%%", confidence * 100));
        });
    }
